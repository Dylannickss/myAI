  ...
  return (
    ...
    >
      <motion.div
        ...
        className="px-3 py-1 bg-green-600 text-white rounded-2xl max-w-[60%] shadow-sm hover:shadow-md transition-shadow duration-300"
      >
        {message.content}
      </motion.div>
    </motion.div>
  ...
  return (
    ...
    >
      ...
      <motion.div
        whileHover={{ scale: 1.01 }}
        transition={{ type: "spring", stiffness: 300, damping: 20 }}
        className="px-3 py-1 bg-white/90 text-black rounded-2xl max-w-[60%] shadow-sm hover:shadow-md transition-shadow duration-300"
      >
